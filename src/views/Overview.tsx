/**
 * OverviewView — Payload custom admin view registrada en `/admin/overview`.
 *
 * Puerto de la antigua página `(workspace)/overview/page.tsx`, con los enlaces
 * de acción apuntando al namespace `/admin/...` en vez de las rutas standalone
 * del route group `(workspace)`.
 */
      ...
      <section className="workspace-page-head">
        ...
        {context.canEdit ? (
          <div className="workspace-actions">
            <Link className="workspace-button" href="/admin/tasks"><Plus size={16} /> Nueva tarea</Link>
            <Link className="workspace-button workspace-button-primary" href="/admin/crm"><Plus size={16} /> Nuevo lead</Link>
          </div>
        ) : null}
      </section>
      ...
      <section className="workspace-grid">
        <article className="workspace-card">
          <header className="workspace-card-head">
            ...
            <Link className="workspace-button" href="/admin/tasks">Ver tareas <ArrowRight size={15} /></Link>
          </header>
