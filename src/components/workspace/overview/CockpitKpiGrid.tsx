...
export function CockpitKpiGrid({
  ...
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-2.5">
      ...
      <article className="space-y-2 border border-border bg-card p-3.5 text-card-foreground">
        ...
        <div className="flex items-baseline justify-between">
          <span className="text-3xl font-bold tracking-tight text-foreground">{currency.format(revenuePeriodTotal)}</span>
      ...
      <article className="space-y-2 border border-border bg-card p-3.5 text-card-foreground">
        ...
        <div className="flex items-baseline justify-between">
          <span className="text-3xl font-bold tracking-tight text-foreground">{currency.format(weightedPipelineTotal)}</span>
      ...
      <article className="space-y-2 border border-border bg-card p-3.5 text-card-foreground">
        ...
        <div className="flex items-baseline justify-between">
          <span className="text-3xl font-bold tracking-tight text-foreground">{totalLeadsActive}</span>
        ...
        <div className="space-y-1">
          <div className="flex justify-between text-[11px] font-mono text-muted-foreground">
            ...
            <span className="flex items-center gap-1.5">
              ...
              <span className="text-muted-foreground">· {conversionsInPeriod} conv.</span>
      ...
      <article className="space-y-2 border border-border bg-card p-3.5 text-card-foreground">
        ...
        <div className="flex items-baseline justify-between">
          <span className="text-3xl font-bold tracking-tight text-foreground">{overdueTasksCount}</span>
      ...
      <article className="space-y-2 border border-border bg-card p-3.5 text-card-foreground">
        ...
        <div className="flex items-baseline justify-between">
          <span className="text-3xl font-bold tracking-tight text-foreground">{currency.format(revenuePendingTotal)}</span>
        ...
        <div className="text-[11px] font-mono text-muted-foreground">
          ...
          {quotesActiveTotal > 0 && (
            <span className="text-foreground/80"> · {quotesActiveCount} cotiz. ({currency.format(quotesActiveTotal)})</span>
          )}
      ...
      <article className="space-y-2 border border-border bg-card p-3.5 text-card-foreground">
        ...
        <div className="flex items-baseline justify-between">
          <span className="text-3xl font-bold tracking-tight text-foreground">{metaHealthPct.toFixed(1)}%</span>
