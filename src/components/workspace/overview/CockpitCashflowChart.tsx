...
export function CockpitCashflowChart({ points }: CockpitCashflowChartProps) {
  ...
  return (
    <div className="p-3.5 bg-card text-card-foreground border border-border space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pt-2.5 border-t border-border font-mono text-[11px]">
